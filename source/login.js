$(document).ready(function (e) {
  ...
  function login_proses() {
    ...
    if (userid.length == "") {
      ...
      toastr.error("Userid Tidak Boleh Kosong!", "Failed !"), e.error;
      ...
      toastr.error("Password Tidak Boleh Kosong!", "Failed !"), e.error;
    } else {
      $.ajax({
        ...
        success: function (response) {
          ...
          if (decode.status == 200) {
            ...
            toastr.warning("Akun Anda tidak terdaftar di sistem!", "Failed !"),
              decode.error;
          }
